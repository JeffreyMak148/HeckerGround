    ...
    return (
        <div className="terms">
            <ul>
                ...
                <li>
                    <h1><strong>Interpretation and Definitions</strong></h1>
                    ...
                    <li>
                    <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Heckerground.com.</p>
                    </li>
                    <li>
                    ...
                    <li>
                    <p><strong>"Terms and Conditions"</strong> (also referred as "Terms" or "Terms of Use") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions Agreement was generated by TermsFeed Terms and Conditions Generator.</p>
                    </li>
                    <li>
                    <p><strong>"Third-party Social Media Service"</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
                    </li>
                    <li>
                    <p><strong>"Website"</strong> refers to Heckerground.com, accessible from heckerground.com.</p>
                    </li>
                    <li>
                ...
                <li>
                    <h1><strong>User Accounts</strong></h1>
                ...
                <li>
                    ...
                    <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of us via email heckerground@gmail.com and include in Your notice a detailed description of the alleged infringement.</p>
                    ...
                    <p>You can contact us via email heckerground@gmail.com. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
                </li>
                <li>
                    <h1><strong>Intellectual Property</strong></h1>
                ...
                <li>
                    <h1><strong>Your Feedback to Us</strong></h1>
                ...
                <li>
                    <h1><strong>"AS IS" and "AS AVAILABLE" Disclaimer</strong></h1>
                ...
                <li>
                    ...
                    <p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time, You agree that each visit You make to Heckerground.com shall be subject to the current terms and conditions as published on our website at Heckerground.com.</p>
                ...
                <li>
                    ...
                    <ul>
                        <li>By sending us an email: heckerground@gmail.com</li>
                    </ul>
                </li>
            </ul>
            <p></p>
